...
- 본문의 맨 마지막 줄에는 반드시 "[🎥 관련 유튜브 영상 더 찾아보기](https://www.youtube.com/results?search_query=${encodeURIComponent(newsItem.title)})" 마크다운 링크를 추가하세요.
...
- 맨 마지막 줄에는 반드시 "[🎥 관련 유튜브 영상 더 찾아보기](https://www.youtube.com/results?search_query=${encodeURIComponent(newsItem.title)})" 마크다운 링크를 추가하세요.
