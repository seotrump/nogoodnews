...
2. 기사 내용을 바탕으로 아래 구조에 맞춰 작성하세요:
  - 1줄 (제목): 기사의 핵심 키워드를 중심으로 아주 자극적이고 전문적인 '어그로성 제목'을 작성하세요.
    * [금지 규칙 1]: 1줄에는 절대로 '#' (해시태그) 기호를 사용하지 마세요. (첫 단락/첫 줄 해시태그 사용 엄금)
    * [금지 규칙 2]: 1줄 제목은 "~한다", "~이다", "~했습니다" 같은 구구절절한 완결 설명문 서술어를 쓰지 말고, 핵심 키워드 중심(예: "FOMC 금리 인상 파장", "네이버 AI 대격변")의 명사형/키워드형으로 강력하게 작성하세요.
