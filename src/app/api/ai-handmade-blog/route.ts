...
3. 블루오션 키워드 전략: 제공된 **'블루오션 전략 키워드(${blueOceanKeyword || ''})' 및 '중간 검색량 키워드(${mediumKeyword || ''})'**를 파생시켜 문맥에 맞게 2~3회 이상 자연스럽게 섞어서 반복 사용하세요. 이를 통해 검색 노출과 롱테일 트래픽을 장악하세요!
...
9. 기계적 말투 금지: "결론적으로 말하자면", "요약하자면", "오늘은 ~에 대해 알아보았습니다" 같은 AI 특유의 스팸성 멘트를 절대 사용하지 마세요. 사람 냄새 나는 경험담이나 당신의 페르소나 특유의 말투를 듬뿍 담아내세요.

위 지침들을 모두 반영하여, 마크다운 코드블록(\`\`\`) 없이 순수한 마크다운 텍스트만 출력하세요.`
