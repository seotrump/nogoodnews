...
CREATE OR REPLACE FUNCTION "public"."add_points"("user_id" "uuid", "points_to_add" integer) RETURNS "void"
...
ALTER FUNCTION "public"."add_points"("user_id" "uuid", "points_to_add" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."posthog_metrics" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "date" "date" NOT NULL,
...
ALTER TABLE "public"."posthog_metrics" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."site_settings" (
    ...
    "auto_bot_prompt" "text",
    "auto_bot_profile_prompt" "text",
    "pro_bot_prompt_1_concept" "text",
    "pro_bot_prompt_2_script" "text",
    "pro_bot_prompt_3_param" "text",
    "pro_bot_prompt_4_avatar" "text",
    "feed_prompt_lite" "text",
    "feed_prompt_pro" "text"
);
...
ALTER TABLE ONLY "public"."posthog_metrics"
    ADD CONSTRAINT "posthog_metrics_date_key" UNIQUE ("date");



ALTER TABLE ONLY "public"."posthog_metrics"
    ADD CONSTRAINT "posthog_metrics_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."site_visits"
    ADD CONSTRAINT "site_visits_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."accounts"("id") ON DELETE SET NULL;
...
CREATE POLICY "Allow read access to anyone" ON "public"."posthog_metrics" FOR SELECT USING (true);
...
GRANT ALL ON FUNCTION "public"."add_points"("user_id" "uuid", "points_to_add" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."add_points"("user_id" "uuid", "points_to_add" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_points"("user_id" "uuid", "points_to_add" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."posthog_metrics" TO "anon";
GRANT ALL ON TABLE "public"."posthog_metrics" TO "authenticated";
GRANT ALL ON TABLE "public"."posthog_metrics" TO "service_role";
